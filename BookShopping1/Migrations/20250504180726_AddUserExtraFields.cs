    ...
    public partial class AddUserExtraFields : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RateWebsites", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Imaget = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GenreId = table.Column<int>(type: "int", nullable: false),
                    EpubFilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    F2bFilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MobiFilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    WaitingList = table.Column<string>(type: "nvarchar(max)", nullable: false),
